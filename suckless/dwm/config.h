...
static const Rule rules[] = {
  ...
  RULE(.instance = "spfile", .scratchkey = 's', .isfloating = 1)
	#elif SCRATCHPADS_PATCH
...
static const char *sp1[]      = { "s", "st", "-n", "spterm", "-g", "120x30", NULL };
static const char *sp2[]      = { "s", "st", "-n", "spfile", "-g", "150x40", "-e", "ranger", NULL };
...
static const Key keys[] = {
  ...
  // scratchpads
  { MODKEY,                       XK_u,          togglescratch,   {.v = sp1 }},
  { MODKEY,                       XK_f,          togglescratch,   {.v = sp2 }},
	/* modifier                     key            function                argument */
	#if KEYMODES_PATCH
	...
	{ MODKEY|Mod1Mask|ControlMask,  XK_Tab,        rotatelayoutaxis,       {.i = -4 } },   /* flextile, 4 = secondary stack axis */
